    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "left-4 group-data-[side=right]:right-4 top-4 h-[calc(100svh-theme(spacing.8))]"
            : "left-0 group-data-[side=right]:right-0 group-data-[side=right]:border-r-0 group-data-[side=right]:border-l",
          "group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]",
          "group-data-[collapsible=offcanvas]:group-data-[side=right]:right-[calc(var(--sidebar-width)*-1)]",
          "group-data-[collapsible=icon]:w-[--sidebar-width-icon]",
          variant === "inset" &&
            "border bg-background shadow-md group-data-[collapsible=icon]:shadow-sm group-data-[collapsible=icon]:border-r",
          variant === "floating" &&
            "rounded-lg border bg-background shadow-2xl group-data-[collapsible=icon]:shadow-md",
          variant === "sidebar" && "group-data-[collapsible=none]:border-r",
          className
        )}
        {...props}
      >
