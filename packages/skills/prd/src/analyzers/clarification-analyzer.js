...
import { assessConfidence, assessInputCompleteness, assessContextRichness, CONFIDENCE_THRESHOLDS, CONTENT_VALIDATION } from '@product-agents/prd-shared';
...
export class ClarificationAnalyzer extends BaseAnalyzer {
    async analyze(input) {
        ...
        const confidenceAssessment = assessConfidence({
            ...
            contentSpecificity: rawResult.missingCritical.length === CONTENT_VALIDATION.MAX_MISSING_ITEMS_FOR_HIGH
                ? 'high'
