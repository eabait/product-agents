...
import { assessConfidence, assessInputCompleteness, assessContextRichness, assessContentSpecificity } from '@product-agents/prd-shared';
...
export class ContextAnalyzer extends BaseAnalyzer {
    async analyze(input) {
        const rawAnalysis = await this.generateStructured({
            ...
            arrayFields: [
                // Specify array fields for fallback post-processing
                'themes',
