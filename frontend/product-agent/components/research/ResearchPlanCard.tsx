...
export function ResearchPlanCard({
  ...
  const safePlan = {
    ...
    estimatedSources: typeof plan?.estimatedSources === 'number' ? plan.estimatedSources : undefined,
    estimatedDuration: typeof plan?.estimatedDuration === 'string' ? plan.estimatedDuration : undefined,
